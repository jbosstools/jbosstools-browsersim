...
public class GalaxyS3Skin  extends AppleIPhone3ResizableSkin {
	public static final String ANDROID_SKIN_ID = "Galaxy S III";
	private static final Point NORMAL_SKREEN_SIZE = new Point(360, 398);
	private static final Point NORMAL_SKIN_SIZE = new Point(428, 572);
	public static final int[] VISIBLE_REGION_VERTICAL = { 146, 0, 280, 0, 281, 1, 302, 1, 303, 2, 318, 2, 319, 3, 330,
