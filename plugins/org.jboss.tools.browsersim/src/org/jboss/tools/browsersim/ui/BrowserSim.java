...
import org.jboss.tools.browsersim.BrowserSimLogger;
...
import org.jboss.tools.browsersim.js.log.ConsoleLogConstants;
import org.jboss.tools.browsersim.js.log.JsLogFunction;
import org.jboss.tools.browsersim.js.log.MessageType;
import org.jboss.tools.browsersim.model.Device;
import org.jboss.tools.browsersim.model.preferences.BrowserSimSpecificPreferencesStorage;
import org.jboss.tools.browsersim.model.preferences.CommonPreferences;
import org.jboss.tools.browsersim.model.preferences.CommonPreferencesStorage;
import org.jboss.tools.browsersim.model.preferences.SpecificPreferences;
import org.jboss.tools.browsersim.model.preferences.SpecificPreferencesStorage;
import org.jboss.tools.browsersim.scripting.TouchSupportLoader;
import org.jboss.tools.browsersim.scripting.WebSqlLoader;
...
import org.jboss.tools.browsersim.util.PreferencesUtil;
import org.jboss.tools.browsersim.util.ReflectionUtil;
...
public class BrowserSim {
	public static final String BROWSERSIM_PLUGIN_ID = "org.jboss.tools.browsersim"; //$NON-NLS-1$
	...
	private void initSkin(Class<? extends BrowserSimSkin> skinClass, Point location, final Shell parentShell) {
		...
		shell.addDisposeListener(new DisposeListener() {
			...
			public void widgetDisposed(DisposeEvent arg0) {
				try {
					ReflectionUtil.call("org.jboss.tools.browsersim.devtools.DevToolsDebuggerServer", "stopDebugServer"); //$NON-NLS-1$ //$NON-NLS-2$
				} catch (Exception e) {
