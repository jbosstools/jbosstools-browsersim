...
import org.jboss.tools.browsersim.BrowserSimRunner;
...
public class FileMenuCreator {
	/** @see org.jboss.tools.browsersim.eclipse.callbacks.OpenFileCallback */
	protected static final String OPEN_FILE_COMMAND = "org.jboss.tools.browsersim.command.openFile:"; //$NON-NLS-1$
	/** @see org.jboss.tools.browsersim.eclipse.callbacks.ViewSourceCallback */
	private static final String VIEW_SOURCE_COMMAND = "org.jboss.tools.browsersim.command.viewSource:"; //$NON-NLS-1$
