...
public class IOS8TimeComposite extends AbstractTimeComposite {
	private static final String BD = "ios/iphone6/";
	...
	public IOS8TimeComposite(Composite parent, BrowserSimImageList imageList) {
