...
public class BrowserSimLauncher {
	public static final String BROWSERSIM_CLASS_NAME = "org.jboss.tools.browsersim.ui.launch.BrowserSimRunner"; //$NON-NLS-1$
	...
	public static List<String> getBundles() {
		...
		bundles.add("org.jboss.tools.browsersim.ui"); //$NON-NLS-1$
