 ...
 * <pre>org.jboss.tools.browsersim.ui.BrowserSim.command.openFile:file:///path/to/file</code>
 * 
 * @author Yahor Radtsevich (yradtsevich)
 * @author Ilya Buziuk (ibuziuk)
 */
public class OpenFileCallback implements ExternalProcessCallback {
	private static final String OPEN_FILE_COMMAND = "org.jboss.tools.browsersim.command.openFile:"; //$NON-NLS-1$
